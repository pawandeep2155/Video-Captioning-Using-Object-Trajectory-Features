...
video_path = '../../../dataset/MSVD/videos_224/'
...
def video_array(batch_ids):
    batch_array = {}
    try:
        video = skvideo.io.vread(video_path + batch_ids[0] + '.avi')
...
while batch_start != batch_end:
    ...
    if batch_arrayd != 0 : # video array present
        ...
        if iter <= 1200:
            resnet_feat_path = '../../../dataset/MSVD/resnet_features/train/' + batch_id[0] + '.pt'
        elif iter > 1200 and iter <= 1300:
            resnet_feat_path = '../../../dataset/MSVD/resnet_features/valid/' + batch_id[0] + '.pt'
        else:
            resnet_feat_path = '../../../dataset/MSVD/resnet_features/test/' + batch_id[0] + '.pt'
